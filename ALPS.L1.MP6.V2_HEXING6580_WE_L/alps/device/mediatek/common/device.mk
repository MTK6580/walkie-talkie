...
ifeq ($(strip $(MTK_INTERPHONE_SUPPORT)),yes)
PRODUCT_PACKAGES += InterPhone
endif
...
# meta tool
PRODUCT_PROPERTY_OVERRIDES += ro.mediatek.version.branch=L1
...
ifeq ($(strip $(MTK_HDMI_3D_SUPPORT)), yes)
  PRODUCT_PROPERTY_OVERRIDES += ro.mtk_hdmi_3d_support=1
endif
...
ifeq ($(strip $(MTK_C2K_SUPPORT)), yes)
  ...
  # ecclist
  PRODUCT_PROPERTY_OVERRIDES += ro.ril.ecclist.cdma=110,112,119,120,999,911,122
endif
...
ifeq ($(strip $(MTK_PDDS_PACKAGE)), yes)
	PRODUCT_PACKAGES += PDDS
endif
...
ifeq ($(strip $(MTK_ROTATION_SUPPORT)), yes)
PRODUCT_PACKAGES += Rotation
endif
#Add for CCCI Lib
