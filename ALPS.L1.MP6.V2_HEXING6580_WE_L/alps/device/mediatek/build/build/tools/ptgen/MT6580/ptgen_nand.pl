...
if($ENV{PTGEN_CHECKOUT} eq "yes")
{
  ...
  #copy path for different project setting
  $COPY_PATH_PARTITION_DEFINE_H_NAME_PL="bootable/bootloader/preloader/custom/$PROJECT/inc";
  $COPY_PATH_PMT_H_NAME_PL="bootable/bootloader/preloader/custom/$PROJECT/inc";  
  $COPY_PATH_PreloaderC="bootable/bootloader/preloader/custom/$PROJECT/inc";
  
  $COPY_PATH_PARTITION_DEFINE_H_NAME_LK="bootable/bootloader/lk/target/$PROJECT/inc";
  $COPY_PATH_PMT_H_NAME_LK="bootable/bootloader/lk/target/$PROJECT/inc";
  $COPY_PATH_LK_MT_PartitionH="bootable/bootloader/lk/target/$PROJECT/inc";
  $COPY_PATH_LK_PartitionC="bootable/bootloader/lk/target/$PROJECT/inc";
...
else
{
  ...
  #copy path for different project setting
  $COPY_PATH_PARTITION_DEFINE_H_NAME_PL="$CD_ALPS/bootable/bootloader/preloader/custom/$PROJECT/inc";
  $COPY_PATH_PMT_H_NAME_PL="$CD_ALPS/bootable/bootloader/preloader/custom/$PROJECT/inc";  
  $COPY_PATH_PreloaderC="$CD_ALPS/bootable/bootloader/preloader/custom/$PROJECT/inc";
  
  $COPY_PATH_PARTITION_DEFINE_H_NAME_LK="$CD_ALPS/bootable/bootloader/lk/target/$PROJECT/inc";
  $COPY_PATH_PMT_H_NAME_LK="$CD_ALPS/bootable/bootloader/lk/target/$PROJECT/inc";
  $COPY_PATH_LK_MT_PartitionH="$CD_ALPS/bootable/bootloader/lk/target/$PROJECT/inc";
