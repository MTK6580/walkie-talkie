...
typedef enum {
	VCDT_HV_VOLT_04_200000_V,
	VCDT_HV_VOLT_04_250000_V,
	VCDT_HV_VOLT_04_300000_V,
	VCDT_HV_VOLT_04_350000_V,
	
	VCDT_HV_VOLT_04_400000_V,
	VCDT_HV_VOLT_04_450000_V,
	VCDT_HV_VOLT_04_500000_V,
	VCDT_HV_VOLT_04_550000_V,
	
	VCDT_HV_VOLT_04_600000_V,
	VCDT_HV_VOLT_06_000000_V,
	VCDT_HV_VOLT_06_500000_V,
	VCDT_HV_VOLT_07_000000_V,
	
	VCDT_HV_VOLT_07_500000_V,
	VCDT_HV_VOLT_08_500000_V,
	VCDT_HV_VOLT_09_500000_V,
	VCDT_HV_VOLT_10_500000_V,
	BATTERY_VOLT_MAX,
	BATTERY_VOLT_INVALID
} BATTERY_VOLTAGE_ENUM;

#define V_CHARGER_MAX VCDT_HV_VOLT_06_500000_V				// 6.5 V
...
{    
	...
	pmic_read_interface( MT6350_STRUP_CON8, (&just_rst), MT6350_PMIC_JUST_PWRKEY_RST_MASK, MT6350_PMIC_JUST_PWRKEY_RST_SHIFT );
	pmic_config_interface(MT6350_STRUP_CON9, 1, MT6350_PMIC_CLR_JUST_RST_MASK, MT6350_PMIC_CLR_JUST_RST_SHIFT);
...
void pl_check_bat_protect_status(void)
{
    ...
    print( "[%s]: check VBAT=%d mV with %d mV, start charging... \n", __FUNCTION__, bat_val, BATTERY_LOWVOL_THRESOLD);


	while (bat_val < BATTERY_LOWVOL_THRESOLD)
	{
		mtk_wdt_restart();
		if(pmic_IsUsbCableIn() == KAL_FALSE)
		{
			print( "[BATTERY] No Charger, Power OFF !\n");
			break;
		}
