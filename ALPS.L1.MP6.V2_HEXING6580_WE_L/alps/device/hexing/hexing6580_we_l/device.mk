...
# PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/ueventd.mt6580.rc:root/ueventd.mt6580.rc

PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/meta_init.project.rc:root/meta_init.project.rc

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/hexing/hexing6580_we_l/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif
...
ifeq ($(TARGET_BUILD_VARIANT),eng)
    PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/thermal_eng.conf:system/etc/.tp/thermal.conf
else
    PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/thermal.conf:system/etc/.tp/thermal.conf
endif
...
PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_we_l/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_we_l/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6580/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/audio_policy.conf:system/etc/audio_policy.conf

# bootanimation.zip
PRODUCT_COPY_FILES += device/hexing/hexing6580_we_l/bootanimation.zip:system/media/bootanimation.zip
#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_we_l/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_we_l/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_we_l/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png
...
DEVICE_PACKAGE_OVERLAYS += device/hexing/hexing6580_we_l/overlay
