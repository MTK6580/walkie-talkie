...
include device/hexing/$(MTK_TARGET_PROJECT)/ProjectConfig.mk
...
PRODUCT_COPY_FILES += device/hexing/$(MTK_TARGET_PROJECT)/enableswap.sh:root/enableswap.sh
PRODUCT_COPY_FILES += device/hexing/$(MTK_TARGET_PROJECT)/fstab.mt6580:root/fstab.mt6580

# overlay has priorities. high <-> low.
DEVICE_PACKAGE_OVERLAYS += device/hexing/$(MTK_TARGET_PROJECT)/overlay
...
# PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/egl.cfg:system/lib/egl/egl.cfg
# PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/ueventd.mt6580.rc:root/ueventd.mt6580.rc

PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/factory_init.project.rc:root/factory_init.project.rc
PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/init.project.rc:root/init.project.rc
PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/meta_init.project.rc:root/meta_init.project.rc

PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/fstab.mt6580:root/fstab.mt6580

ifeq ($(MTK_SMARTBOOK_SUPPORT),yes)
PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/sbk-kpd.kl:system/usr/keylayout/sbk-kpd.kl \
                      device/hexing/hexing6580_weg_l/sbk-kpd.kcm:system/usr/keychars/sbk-kpd.kcm
endif

# Add FlashTool needed files
#PRODUCT_COPY_FILES += device/hexing/$(MTK_TARGET_PROJECT)/EBR1:EBR1
#ifneq ($(wildcard device/hexing/$(MTK_TARGET_PROJECT)/EBR2),)
#  PRODUCT_COPY_FILES += device/hexing/$(MTK_TARGET_PROJECT)/EBR2:EBR2
#endif
#PRODUCT_COPY_FILES += device/hexing/$(MTK_TARGET_PROJECT)/MBR:MBR
#PRODUCT_COPY_FILES += device/hexing/$(MTK_TARGET_PROJECT)/MT6580_Android_scatter.txt:MT6580_Android_scatter.txt

# thermal policy
ifeq ($(TARGET_BUILD_VARIANT),eng)
    PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/thermal_eng.conf:system/etc/.tp/thermal.conf
else
    PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/thermal.conf:system/etc/.tp/thermal.conf
endif
...
PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/android.hardware.telephony.gsm.xml:system/etc/permissions/android.hardware.telephony.gsm.xml
...
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/sound/sinewave1k.wav:system/res/sound/sinewave1k.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/sound/sinewave2k.wav:system/res/sound/sinewave2k.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/sound/sinewave3k.wav:system/res/sound/sinewave3k.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/sound/sinewave4k.wav:system/res/sound/sinewave4k.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/sound/sinewave05k.wav:system/res/sound/sinewave05k.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/sound/sinewave15k.wav:system/res/sound/sinewave15k.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/sound/sinewave25k.wav:system/res/sound/sinewave25k.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/sound/sinewave35k.wav:system/res/sound/sinewave35k.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/common/factory/res/sound/sinewave075k.wav:system/res/sound/sinewave075k.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_weg_l/factory/res/sound/testpattern1.wav:system/res/sound/testpattern1.wav
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_weg_l/factory/res/sound/ringtone.wav:system/res/sound/ringtone.wav

# Keyboard layout
PRODUCT_COPY_FILES += device/mediatek/mt6580/ACCDET.kl:system/usr/keylayout/ACCDET.kl
PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/mtk-kpd.kl:system/usr/keylayout/mtk-kpd.kl

# Microphone
PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/android.hardware.microphone.xml:system/etc/permissions/android.hardware.microphone.xml

# Camera
PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/android.hardware.camera.xml:system/etc/permissions/android.hardware.camera.xml

# Audio Policy
PRODUCT_COPY_FILES += device/hexing/hexing6580_weg_l/audio_policy.conf:system/etc/audio_policy.conf

#Images for LCD test in factory mode
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_weg_l/factory/res/images/lcd_test_00.png:system/res/images/lcd_test_00.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_weg_l/factory/res/images/lcd_test_01.png:system/res/images/lcd_test_01.png
PRODUCT_COPY_FILES += vendor/mediatek/proprietary/custom/hexing6580_weg_l/factory/res/images/lcd_test_02.png:system/res/images/lcd_test_02.png
...
DEVICE_PACKAGE_OVERLAYS += device/hexing/hexing6580_weg_l/overlay
...
$(call inherit-product-if-exists, vendor/hexing/libs/$(MTK_TARGET_PROJECT)/device-vendor.mk)
