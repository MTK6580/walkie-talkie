...
ifeq ($(strip $(MTK_QUICKSEARCHBOX_APP)), yes)
...
PRODUCT_COPY_FILES += device/mediatek/mt6580/init.ssd_nomuser.rc:root/init.ssd_nomuser.rc
else
PRODUCT_COPY_FILES += device/mediatek/mt6580/init.ssd.rc:root/init.ssd.rc
endif
else
PRODUCT_COPY_FILES += device/mediatek/mt6580/init.no_ssd.rc:root/init.no_ssd.rc
endif
